...
namespace CeresCore
{
    ...
    struct CollinearitySiedelError {
        CollinearitySiedelError(double observed_x, double observed_y)
        ...
        bool operator()(const T* const sensor,
            ...
            T r2 = x * x + y * y;
            T r = sqrt(r2);
            T rad = (T(1.0) + sensor[13] * r + sensor[5] * r2 + sensor[14] * r * r2 + sensor[6] * r2 * r2 
                + sensor[15] * r * r2 * r2 + sensor[7] * r2 * r2 * r2 
                + sensor[16] * r * r2 * r2 * r2 + sensor[8] * r2 * r2 * r2 * r2);
        ...
        static ceres::CostFunction* CreateAutoDiff(const double observed_x,
            ...
            return (new ceres::AutoDiffCostFunction<CollinearitySiedelError, 2, 17, 6, 3>(
                new CollinearitySiedelError(observed_x, observed_y)));
        }
